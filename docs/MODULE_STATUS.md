...
- [x] Schema e API interna para cadastro simples de mesas por loja
- [x] Schema e API interna para abrir/alterar status de sessao/comanda
- [x] Tela operacional inicial de mesas/comandas
